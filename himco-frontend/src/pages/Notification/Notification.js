...
function Notification(props) {
  ...
  return (
    ...
    <table className='notification-table'>
        <thead style={{backgroundColor:'#B80000'}}>
          <tr style={{color:'white'}}>
            ...
            <th className='Notification-Description' style={{padding:'0px 10px'}}>Description</th>
    ...
    {arr.map((element)=>{ return <tr key={element.id} style={{borderBottom:'1px solid black'}}>
        ...
        {element.attributes.Description?<td className='Notification-Description' style={{padding:'0px 10px'}}>{element.attributes.Description}</td>:<td className='Notification-Description' style={{padding:'0px 10px'}}>...</td>}
