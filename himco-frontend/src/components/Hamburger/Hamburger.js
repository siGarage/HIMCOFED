...
const handelClick=(text)=>{
 if(regex1.test(text)){
  ...
  <div onClick={closeNav}><Link  to="/schemes" style={{color:'white',fontSize:'18px'}}>Downloads</Link></div>
  <div onClick={closeNav}><Link  to="/downloads" style={{color:'white',fontSize:'18px'}}>Schemes</Link></div>
</div>
